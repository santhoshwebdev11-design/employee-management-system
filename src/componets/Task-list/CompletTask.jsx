...
const CompletTask = ({data}) => {
  return (
    <div className="shrink-0 h-full w-[300px] bg-green-300 rounded-3xl p-5">
      ...
      <div className="flex justify-center mt-4">
        <button className="bg-green-500 w-full py-1 px-2 text-sm rounded-3xl hover:bg-green-800"> completed</button>
